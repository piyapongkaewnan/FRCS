...
");
        ...
        define("MENU_SAVE_ONLY", "<span class='doAction'><button type='submit' class='btn btn-primary'  id='btnSave' rel='actionSave'><i class='fa fa-save'></i> Save</button></span>");
