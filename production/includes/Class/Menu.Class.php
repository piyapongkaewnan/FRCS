...
class MENU extends Auth {
    ...
    public function showTopNavBar() {
        ...
        echo "                <li class=''> <a href='javascript:;' class='user-profile dropdown-toggle' data-toggle='dropdown' aria-expanded='false'> <img src='" . Auth::getProfileAvatar() . "' alt=''>" . Auth::getRealName() . "&nbsp;<span class=' fa fa-angle-down'></span> </a>\n";
