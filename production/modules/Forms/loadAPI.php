	...
	?>
        <div class="form-group ">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" id="API_<?=$i?>" class="form-control col-md-7 col-xs-12 input-sm text-api te" value="API Data URL <?=$i?>" readonly>
          </div>
        </div>
        <?php } ?>
      </form>
      ...
      <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          <button type="button" id="loadAPI" class="btn btn-danger"><i class="fa fa-bolt"></i> Load APIs</button>
        </div>
      </div>
    </div>
    <div id="step-2">
      ...
      <p>
      <div id="showData">Data to Load</div>
      </p>
    </div>
    <div id="step-3">
...
<!-- /jQuery Smart Wizard -->
<span id="StoreData"></span>


  <table class="table">
  <tr ng-repeat="n in items">
  <td>{{ n.countryCode }}</td><td>{{ n.age }}</td>
  </tr>
  </table>