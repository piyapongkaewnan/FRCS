...
<form id="form_<?= $Config['page'] ?>" name="form_<?= $Config['page'] ?>" method="post" data-parsley-validate class="form-horizontal form-label-left">
    ...
    <div class="form-group">
        ...
        <div class="col-md-3 col-sm-2 col-xs-12">
            <input type="number" id="session_timeout" name="session_timeout" value="<?= $rs_site['session_timeout'] ?>" class="form-control col-md-7 col-xs-12 has-feedback-left" required="required" max="<?= $maxlifetime ?>" min="1">
