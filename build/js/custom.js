...
var setURL = '?modules='+modules+'&page='+page;

var CURRENT_URL =setURL; // window.location.href.split('?')[1],
    $BODY = $('body'),
...
$(document).ready(function() {
    ...
    // check active menu
   if(CURRENT_URL == undefined || page == ""){
	   $('.MenuHome').addClass('active');
   }
  // console.log(CURRENT_URL);
    $SIDEBAR_MENU.find('a[href="' + CURRENT_URL + '"]').parent('li').addClass('current-page');

    $SIDEBAR_MENU.find('a[href="' + CURRENT_URL + '"]').parent('li').addClass('current-page').parents('ul').slideDown(function() {
        setContentHeight();
